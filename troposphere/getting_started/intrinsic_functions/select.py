from troposphere import Template, Parameter, Ref, Select
import troposphere.ec2 as ec2

t = Template()

p_vpc_cidr = t.add_parameter(Parameter('VpcCidr', Type='String', Default='10.0.0.0/24'))
p_subnets_cidr = t.add_parameter(Parameter('Subnets', Type='CommaDelimitedList', Default='10.0.0.0/25,10.0.0.128/25'))
